...
class SentencePieceVocabulary(Vocabulary):
  ...
  def _load_model(self):
    ...
    with self._load_model_lock:
      ...
      s1=self._sentencepiece_model_file
      #with tf.io.gfile.GFile(self._sentencepiece_model_file, "rb") as f:
      s2=s1[5:]
      #print(s2)
      s0="/home/huzhiyao/cxsj/datas/"
      s=s0+s2
      #print(s)
      #with open(s,"rb") as f:
      with tf.io.gfile.GFile(s, "rb") as f:
        #print(-1)
        #print(self._sentencepiece_model_file)
        #print(0)
        #print(f)
  ...
  def __str__(self) -> str:
    logging.warning(
        ' \n \n \n   __str__  \n \n \n \n')
    print(self._sentencepiece_model_file)
    print(self.extra_ids)
    print(hashlib.md5(self.sp_model).hexdigest())
